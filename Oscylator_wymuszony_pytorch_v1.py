...
# Definicja domeny 
t_domain = torch.linspace(0,T,n).view(-1,1).requires_grad_(True)
...
scheduler = StepLR(optimizer, step_size=2500, gamma=0.9)
...
y_an = analityczny_oscylator_wymuszony(t=t, m=m, c=c, k=k, F0=F0, omega_f=omega_f, T=T, n=n, y_0=y_0, v_0=v_0)
